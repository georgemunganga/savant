                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody style="margin-top: 15px;">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="color:#444; font-weight: 400;">
                                                                            ...
                                                                            {!! $content['message'] !!}
                                                                            <br>
                                                                            {{ __('Your login credentials are provided below') }}:
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Email') }}:
                                                                                &nbsp;</span><span
                                                                                style="font-weight:lighter;">{{ $content['email'] }}</span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Password') }}:
                                                                                &nbsp;</span><span
                                                                                style="font-weight:lighter;">{{ $content['password'] }}</span>
                                                                            <br><br>
                                                                            <br>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div>
                                                            <a style="background-color:#d97a36;border-radius:4px;color:#fff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;"
                                                                href="{{ route('login') }}">{{ __('Visit Account') }}</a>
                                                        </div>
                                                        <br>
                                                    </td>
                                                </tr>
                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0" class="force-full-width"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="color:#444;">
                                                        <p>
                                                            {{ __('The password was auto-generated, however feel free to change it.') }}
                                                            <a href="{{ route('profile') }}"
                                                                style="text-decoration: underline;">{{ __('Click Here') }}</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
