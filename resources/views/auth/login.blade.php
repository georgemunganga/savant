...
{{--                                                            <td colspan="2" id="adminCredentialShow" class="login-info">--}}
                    ...
                    <div class="col-md-6">
                        <div class="sign-up-left-content position-relative">
                            ...
                            <h1 class="text-white" >{{ __(getOption('sign_in_text_title')) }} <span style="font-size: 34px; line-height: 42px;     font-weight: 700 !important;" class="theme-btn theme-button1 theme-button3 fw-bold">Living</span></h1>
                            <p class="mt-25 w-75 mr-auto" style="align-self: flex-start !important;">{{ __(getOption('sign_in_text_subtitle')) }}</p>
                        </div>
                    </div>
                </div>
            </div>
