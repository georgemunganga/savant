                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-25">
                                                                    ...
                                                                    <input type="text" name="job"
                                                                        ...
                                                                        placeholder="{{ __('Job') }}">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mt-3 mb-2">{{ __('Tenant Type') }}
                                                                        <span class="text-danger">*</span></label>
                                                                    <select name="tenant_type" class="form-control">
                                                                        <option value="person" {{ $tenant->tenant_type == 'person' ? 'selected' : '' }}>{{ __('Person') }}</option>
                                                                        <option value="student" {{ $tenant->tenant_type == 'student' ? 'selected' : '' }}>{{ __('Student') }}</option>
                                                                        <option value="company" {{ $tenant->tenant_type == 'company' ? 'selected' : '' }}>{{ __('Company') }}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-25">
                                                                    ...
                                                                    <input type="date" name="date_of_birth"
                                                                        value="{{ $tenant->date_of_birth }}" class="form-control"
